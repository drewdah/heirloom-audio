    ...
    <div className="min-h-screen flex items-center justify-center" style={{ background: "var(--bg-base)" }}>
      ...
      <div className="relative z-10 w-full max-w-sm mx-6">
        ...
        <div className="ha-card p-8">
          <h2 className="text-base font-semibold mb-1" style={{ color: "var(--text-primary)", fontFamily: "var(--font-sans)" }}>Sign in</h2>
          <p className="text-sm mb-6" style={{ color: "var(--text-tertiary)", fontFamily: "var(--font-sans)" }}>Use your Google account to continue</p>
          <button
